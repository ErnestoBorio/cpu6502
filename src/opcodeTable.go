...
var Opcodes = [0x100] Operation {
	...
	{ Opcode: 0x10, Length: 2, Cycles: 2, Documented: true , Instruction: (*CPU).bpl,   Addressing: (*CPU).implied},
	...
	{ Opcode: 0x30, Length: 2, Cycles: 2, Documented: true , Instruction: (*CPU).bmi,   Addressing: (*CPU).implied},
	...
	{ Opcode: 0x50, Length: 2, Cycles: 2, Documented: true , Instruction: (*CPU).bvc,   Addressing: (*CPU).implied},
	...
	{ Opcode: 0x70, Length: 2, Cycles: 2, Documented: true , Instruction: (*CPU).bvs,   Addressing: (*CPU).implied},
	...
	{ Opcode: 0x90, Length: 2, Cycles: 2, Documented: true , Instruction: (*CPU).bcc,   Addressing: (*CPU).implied},
	...
	{ Opcode: 0xB0, Length: 2, Cycles: 2, Documented: true , Instruction: (*CPU).bcs,   Addressing: (*CPU).implied},
	...
	{ Opcode: 0xD0, Length: 2, Cycles: 2, Documented: true , Instruction: (*CPU).bne,   Addressing: (*CPU).implied},
	...
	{ Opcode: 0xF0, Length: 2, Cycles: 2, Documented: true , Instruction: (*CPU).beq,   Addressing: (*CPU).implied},
